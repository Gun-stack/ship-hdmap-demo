...
/** Body of POST /api/datasets/{id}/seed. The Unity generator sends the first five lists; a full fixture may also carry slots, landmarks and markings. */
public record SeedData(List<VehicleMap.Deck> decks, List<VehicleMap.Facility> facilities, List<VehicleMap.LashingPoint> lashingPoints,
		...
		List<VehicleMap.Marking> markings) {}
